...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.33]{Imagenes/ConOps.png}
...
Los siguientes diagramas presentan los requerimientos del sistema junto con su trazabilidad y método de verificación. La sintaxis
CON-XXX identifica requerimientos de alcance conceptual, mientras que otros prefijos como ENV corresponden al entorno
operativo. Cada verificación usa el formato V–reqID–método, donde el método puede ser TST (test), INS (inspección),
ANA (análisis) o DEM (demostración). Esta estructura permite identificar el origen del requerimiento y la técnica usada
para verificar su cumplimiento.

Estos diagramas pueden visualizarse a tamaño completo en el \hyperref[chapter:anexo]{Anexo} al final del documento.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Imagenes/1. Concept Level/Requirements/Concept_Requirements.png}
    \caption{Requerimientos de Misión}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Imagenes/1. Concept Level/Requirements/Environment_Requirements.png}
    \caption{Requerimientos Ambientales}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.35]{Imagenes/gantt.png}
...
\includepdf[
    pages=1,
    fitpaper=true,
]{Imagenes/1. Concept Level/Requirements/Concept_Requirements.pdf}
\includepdf[
    pages=1,
    fitpaper=true,
]{Imagenes/1. Concept Level/Requirements/Environment_Requirements.pdf}
\label{chapter:anexo:ce}
