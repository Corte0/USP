...
\textbf{Vacío Extremo} &
Rangos de presión extremos \\
\hline

\textbf{Microgravedad} &
Aceleración residual muy baja \\
\hline

\textbf{Radiación Espacial} &
\textbf{Protones de alta energía} (especialmente en la Anomalía del Atlántico Sur, SAA). \\
\hline

\textbf{Basura Espacial (Debris)} &
Partículas a \textbf{velocidades hiperveloces}. \\
\hline
...
Desaceleración máxima por el frenado atmosférico. \\
\hline

\textbf{Presión Dinámica Máxima (Max Q)} &
Presión aerodinámica intensa sobre la superficie. \\
\hline

\textbf{Plasma Ionizado} &
Vaina de gas ionizado que envuelve el objeto. \\
\hline
