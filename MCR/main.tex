...
\section{Necesidad}
Existen manufacturas que necesitan de ciertas condiciones (microgravedad) que son fácilmente obtenibles en órbita.
La cristalografía tiene estos tipos de problemas.
\\
En condiciones normales (gravedad terrestre) hay 2 grandes problemas
\begin{itemize}
    \item \textbf{Sedimentación y convección:}durante el crecimiento de cristales, la gravedad provoca que las 
      moléculas se desplacen por sedimentación o corrientes de convección térmica.
...
\section{Metas}
\begin{itemize}
  \item Fabricar manufacturas en órbita \acrshort{leo}.
...
\section{Objetivos}
\begin{itemize}
  \item Transportar y proveer servicios a una fábrica en órbita \acrshort{leo}.
...
\\
Impacto sobre la cristalización:
\\
\\
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{Imagenes/Feature_Context.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{Imagenes/Logical_Boundary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Imagenes/Concept_Requirements_1.png}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Imagenes/Concept_Requirements_2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{Imagenes/Diagrama_Gantt_V3.png}
